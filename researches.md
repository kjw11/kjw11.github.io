...
conditions, among which genre mismatch is perhaps the most challenging.
In this work, we firstly publish CN-Celeb, a large-scale multi-genre corpus that includes 
in-the-wild speech utterances of 3,000 speakers in 11 different genres. 
...
* **Squeezing value of cross-domain labels: 
   a decoupled scoring approch for speaker verification**
<font color=gray>
...
<font color=gray>
Mismatch between enrollment and test conditions causes serious performance on speaker recognition 
systems. This paper present a simple yet effective solution to address this problem, 
...
CODE: <a href="https://github.com/kjw11/Robust-MAML">GitHub</a>
